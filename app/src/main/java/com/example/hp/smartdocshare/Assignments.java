...
public class Assignments extends AppCompatActivity {
    ...
    String n,a,b,c,d;
    static final String URL = "http://10.0.2.2/stufac/ass.xml";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (netw != null && netw.isConnected()) {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.CUPCAKE) {
                new LoginAsyncTask().execute("http://10.0.2.2/stufac/insert_ass.php");//https://acc-smartdocshare.000webhostapp.com/insert_ass.php");
            }
        } else {
        ...
        adapter=new la_assignments(this, songsList,number);
        ...
        list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                String nam=song.get(Assignments.KEY_TITLE);

                //Toast.makeText(getApplicationContext(),nam.toString(),Toast.LENGTH_LONG).show();
                Intent in = new Intent(Assignments.this,viewdownload.class);
    ...
    private class LoginAsyncTask extends AsyncTask<String, Void, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pd = ProgressDialog.show(Assignments.this, " ", "loading", true);
